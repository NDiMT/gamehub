...
const MODELS = [
  { name: "mob_wraith", prompt: `ghostly hooded wraith specter with tattered flowing robes and glowing eyes, tabletop board game miniature on a round base, hand-painted style, low poly, stylized proportions, dark fantasy, game asset`, polycount: 5000 },
  { name: "mob_rotfang", prompt: `giant snarling plague rat beast with matted fur and bared fangs, hunched, tabletop board game miniature on a round base, hand-painted style, low poly, stylized proportions, dark fantasy, game asset`, polycount: 5000 },
  { name: "mob_dreadknight", prompt: `heavily armored undead knight with greataxe and closed full helm, tabletop board game miniature on a round base, hand-painted style, low poly, stylized proportions, dark fantasy, game asset`, polycount: 6000 },
];
